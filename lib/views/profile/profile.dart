...
import 'package:delivery_app/views/profile/settings_base.dart';
    ...
    return Base(
      child: Column(
        children: [
          ...
          // ),
          Text(
          Provider.of<AuthProvider>(context, listen: false).currentUser!.firstName.toString(),
          ...
          SizedBox(height: hh(context, 150)),
        ],
      ),
    );
  }
